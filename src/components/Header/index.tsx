...
const Header: React.FC<HeaderProps> = ({ userInfo }) => {
  ...
  return (
    <>
      <header className='w-screen h-16 items-center bg-blue-400 px-6 hidden md:flex'>
        <Logo />
        <div className='w-16 sm:w-16 md:w-16 lg:w-auto flex-1'>
          <Menu
            className='bg-blue-400 text-white border-0'
            items={[
      ...
      <header className='w-screen h-16 items-center bg-blue-400 px-1 flex md:hidden'>
